    ...
    <div class="border-t border-[var(--color-border)] p-3">
      ...
      >
        <button
          ...
          :key="key"
          type="button"
          class="inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-semibold text-white transition hover:opacity-85 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
