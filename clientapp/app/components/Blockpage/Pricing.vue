...
<template>
  <section class="relative isolate overflow-hidden rounded-[2rem] border border-white/70 bg-white/55 px-5 py-7 shadow-2xl shadow-brand-900/10 backdrop-blur-2xl sm:px-8 sm:py-10">
    ...
    <div
      aria-hidden="true"
      class="pointer-events-none absolute -bottom-24 -left-20 -z-10 size-64 rounded-full bg-amber-200/40 blur-3xl"
    />
    ...
    <div class="mt-8 space-y-4">
      ...
      >
        <div
          ...
          aria-hidden="true"
          class="absolute -right-12 -top-12 size-36 rounded-full bg-brand-500/30 blur-3xl"
        />
        ...
        <div class="relative">
          ...
          <div class="mt-5">
            ...
            <p
              ...
              :class="plan.highlighted ? 'text-slate-300' : 'text-slate-600'"
            >
              {{ plan.description }}
            </p>
          </div>
          ...
          <div
            class="my-5 h-px"
            :class="plan.highlighted ? 'bg-white/10' : 'bg-slate-200/80'"
          />
    ...
    <div class="mt-7 rounded-2xl border border-white/80 bg-white/60 p-4 text-center shadow-sm ring-1 ring-slate-900/5 backdrop-blur-xl">
      ...
      <UButton
        ...
        class="mt-4 justify-center rounded-full px-5 shadow-lg shadow-brand-500/20"
      >
